...
class HomeScreenViewModel @Inject constructor(savedStateHandle: SavedStateHandle) : ViewModel() {
    ...
    var recommendedList by savedStateHandle.saveable { mutableStateOf(listOf<Game>()) }
    ...
    init {
        ...
        viewModelScope.launch {
            FBCRUD.getGameList()
                .onCompletion { recommendedList = gameList.shuffled().take(8) } // Aquí lanzo recomendaciones según la lista de games
